...
class MainForm(QWidget):
    ...
    def addButtonClick(self):
        ...
        if self.entryForm.exec_() == QDialog.Accepted:
            ...
            query = QSqlQuery()
            query.exec_("INSERT INTO phonebook VALUES (%d, '%s', '%s')" % (id, self.entryForm.nameLineEdit.text(), self.entryForm.phoneLineEdit.text()))
        self.loadData()
    ...
    def editButtonClick(self):
        ...
        if self.entryForm.exec_() == QDialog.Accepted:
            ...
            query = QSqlQuery()
            query.exec_('''UPDATE phonebook SET nama = '%s', nohp = '%s' WHERE id = %d ''' % (self.entryForm.nameLineEdit.text(), self.entryForm.phoneLineEdit.text(), id))
        self.loadData()
